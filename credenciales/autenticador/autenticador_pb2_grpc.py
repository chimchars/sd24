...
class AutenticadorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.autenticar = channel.unary_unary(
                ...
                request_serializer=autenticador__pb2.HelloRequest.SerializeToString,
                response_deserializer=autenticador__pb2.HelloReply.FromString,
                )
...
def add_AutenticadorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'autenticar': grpc.unary_unary_rpc_method_handler(
                    servicer.autenticar,
                    request_deserializer=autenticador__pb2.HelloRequest.FromString,
                    response_serializer=autenticador__pb2.HelloReply.SerializeToString,
            ),
    }
...
class Autenticador(object):
    ...
    def autenticar(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/autenticador.Autenticador/autenticar',
            autenticador__pb2.HelloRequest.SerializeToString,
            autenticador__pb2.HelloReply.FromString,
